...
public class ImageSplitDialog2 extends JDialog {
	...
	static{
		try{
			defaultImage = ImageIO.read(ImageSplitDialog2.class.getResource("modjam.png"));
		}catch(Exception e){
			e.printStackTrace();
		}
	}
	...
	public static void main(String[] args) {
		try {
			ImageSplitDialog2 dialog = new ImageSplitDialog2();
	 ...
	 * Create the dialog.
	 */
	public ImageSplitDialog2(BufferedImage bi) {
		...
		JLabel lblNewLabel = new JLabel("Number of X Sections");
		...
		JLabel lblNewLabel_1 = new JLabel("X Section");
		...
		JLabel lblYSection = new JLabel("Y Section");
		...
		JLabel lblYSections = new JLabel("Y Sections");
	...
	private void resetImage(){
		...
		for(int x = 0; x < width; x++){
			...
			System.out.println(xBound*getX2slider().getValue());
